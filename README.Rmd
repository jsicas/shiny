...
- O nome das colunas obrigatórias (`code_state` e `code_region`) podem ser alterado no arquivo `config.yaml`, localizado na pasta `./configuracoes`.
...
- Os gráficos podem ser baixados em formato PDF utilizando o botão `Baixar Gráfico`.

### **3. Geográfica**

- Apresenta um mapa do Brasil mostrando a variável selecionada.
- É possível selecionar apenas um estado para visualização.
- O mapa gerado pode ser baixado em formato PDF utilizando o botão `Baixar Gráfico`.
